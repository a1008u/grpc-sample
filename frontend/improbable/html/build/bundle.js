...
const proto = {};
proto.article = __webpack_require__(/*! ./article_pb.js */ "./proto/article_pb.js");
/**
...
proto.article.ArticleServiceClient = function (hostname, credentials, options) {
  if (!options) options = {};
...
proto.article.ArticleServicePromiseClient = function (hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'binary';
  /**
   * @private @const {!grpc.web.GrpcWebClientBase} The client
...
const methodInfo_ArticleService_MkArticle = new grpc.web.AbstractClientBase.MethodInfo(proto.article.ArticleResponse,
...
proto.article.ArticleServiceClient.prototype.mkArticle = function (request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ + '/article.ArticleService/MkArticle', request, metadata || {}, methodInfo_ArticleService_MkArticle, callback);
};
/**
 * @param {!proto.article.ArticleRequest} request The
 *     request proto
...
proto.article.ArticleServicePromiseClient.prototype.mkArticle = function (request, metadata) {
  return this.client_.unaryCall(this.hostname_ + '/article.ArticleService/MkArticle', request, metadata || {}, methodInfo_ArticleService_MkArticle);
};
...
proto.article.ArticleRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.article.Article.serializeBinaryToWriter);
  }
};
/**
...
/* harmony import */ var _proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../proto/article_grpc_web_pb */ "./proto/article_grpc_web_pb.js");
/* harmony import */ var _proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0__);
console.log("--- test ---");
 // import { grpc } from "@improbable-eng/grpc-web/dist/typings";

const host = "http://" + window.location.hostname + ":8080";
const a = new _proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0___default.a.Article();
a.setNo("1");
a.setContent("testtesttesttesttest");
const articleService = new _proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0___default.a.ArticleServicePromiseClient(host);
const req = new _proto_article_grpc_web_pb__WEBPACK_IMPORTED_MODULE_0___default.a.ArticleRequest();
req.setArticle(a);
articleService.mkArticle(req).then(res => console.log("resの結果(成功)", res)).catch(err => console.error("resの結果(失敗)", err)); // var client = new article.ArticleServiceClient(host, {
